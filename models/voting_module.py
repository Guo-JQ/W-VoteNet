...
class VotingModule(nn.Module):
    def __init__(self, vote_factor, seed_feature_dim):
        ...
        self.conv1 = torch.nn.Conv1d(self.in_dim, self.in_dim, 1)  # （256，256，1）
        self.conv2 = torch.nn.Conv1d(self.in_dim, self.in_dim, 1)  # （256，256，1）
        self.conv3 = torch.nn.Conv1d(self.in_dim, (3 + self.out_dim) * self.vote_factor, 1)  # （256，3+256，1）
    ...
    def forward(self, seed_xyz, seed_features, end_points):
        ...
        seed_seg_point = end_points['seed_seg_point']
        vote_features = vote_features * (seed_seg_point.transpose(2, 1).contiguous() + 1e-6)
