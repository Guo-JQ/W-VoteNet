...
parser.add_argument('--checkpoint_path', default='/home/root1/pycharm_project/W_VoteNet/log_sunrgbd_nem32_srm8_wvm/checkpoint.tar',
...
def evaluate_one_epoch():
    ...
    for batch_idx, batch_data_label in enumerate(TEST_DATALOADER):
        ...
        for ap_calculator in ap_calculator_list:
            ap_calculator.step(batch_pred_map_cls,
                               batch_gt_map_cls)  # Accumulate one batch of prediction and groundtruth.
